...
public final class FormatString {
  ...
  public static FormatString compile(String fmt) {
  ...
  private static int next(
      final String fmt, final ArrayList<FmtCmpnt> cmps, final int startIndex) {
  ...
  static void convertFloat(
    ...
    if (arg instanceof Float) {
      ...
      throw new UnknownFormatConversionException(
        "not a floating point number: " + arg
      );
    }
    appendify(a, val, flags, width, precision);
  }
    ...
    public String toString() {
      return 
          "{ " 
              ...
              + "flags = " + Integer.toBinaryString(_flags & 0xFF) + ", " 
              + "arg_index = " + _argument_index + ", " 
              + "width = " + _width + ", " 
